...
#include "../build/ns3/plc-outlet.h"
#include "../build/ns3/plc-output-helper.h"
#include "../build/ns3/plc-helper.h"
#include "../build/ns3/plc-value.h"
#include "../build/ns3/packet-sink-helper.h"
...
//     sm = smHelper.GetSpectrumModel(2e6, 30e6, 1146);
    ...
    Ptr<PLC_Outlet> outlet1 = CreateObject<PLC_Outlet> (PLC1, Create<PLC_ConstImpedance>(sm,PLC_Value(100,0)));
    Ptr<PLC_Outlet> outlet2 = CreateObject<PLC_Outlet> (PLC2, Create<PLC_ConstImpedance>(sm,PLC_Value(40,0)));
...
//    apps_server.Stop (Seconds (10.0));
    ...
    Time interPacketInterval = Seconds (0.65); //
...
//    Time delay;
//    delay = flowMonitor->FlowStats.delaySum.GetSeconds();
